...
export const metadata: Metadata = {
    title: 'Terms & Conditions – NailPrep',
    description: 'Terms and Conditions for the NailPrep mobile application.',
};
        ...
        <div className="min-h-screen bg-canvas">
            ...
            <main className="container mx-auto px-4 max-w-4xl py-12 md:py-20">
                <div className="bg-white rounded-2xl shadow-sm border border-border-light p-8 md:p-12">
                    <h1 className="text-3xl md:text-4xl font-bold text-ink mb-2">Terms &amp; Conditions</h1>
                    <p className="text-muted text-sm mb-10">Effective as of February 27, 2026</p>

                    <div className="space-y-8">

                        <p className="text-body leading-relaxed">
                            These terms and conditions apply to the <strong className="text-ink">NailPrep</strong> app (hereby referred to as "Application") for mobile devices that was created by <strong className="text-ink">Tran Quang Huy</strong> (hereby referred to as "Service Provider") as a Freemium service.
                        </p>
