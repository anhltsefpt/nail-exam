...
export interface UserState {
  ...
  // Roadmap UI State
  flashSetIndex: number | null; // Indicates which set index should pulse when returning to roadmap
  ...
  setFlashSetIndex: (index: number | null) => void;
}
...
export const useUserStore = create<UserState>()(
  persist(
    (set, get) => ({
      ...
      setFlashSetIndex: (index) => set({ flashSetIndex: index }),
